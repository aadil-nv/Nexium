...
import { IPersonalDetailsDTO, ICompanyDetailsDTO, IAddressDTO, IResponseDTO, IDocumentDTO, ILeaveTypesDTO, ILeaveResonseDTO, IPayrollCriteriaDTO } from '../../dto/businessOwnerDTO';
