...
export default function Announcements() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4" style={{ color: currentColor }}>Announcements</h1>
        ...
        {announcements.length === 0 ? (
          ...
          announcements.map(announcement => (
            <div key={announcement.id} className="border rounded-md p-4 flex flex-col">
              <p className="text-gray-800" style={{ color: currentColor }}>{announcement.message}</p>
